...
title = TK Penilaian App

# (str) Package name
package.name = tkpenilaian

# (str) Package domain (needed for android/ios packaging)
package.domain = org.trysandi

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (leave empty to include all the files)
source.include_exts = py,png,jpg,kv,atlas,json,md,ttf,otf,env
...
requirements = python3,kivy,kivymd,pillow,mysql-connector-python,python-dotenv,reportlab
